...
import { TOKEN_METADATA_PROGRAM_ID, NFT_SYMBOL ,collections} from "../data/Constants";
...
const CollectionProvider = (props) => {
  ...
  const loadCollectionHandler = async (connection, pageIndex, pageSize) => {
    ...
    const nftcollectionbytes = new TextEncoder().encode(collections);

    const nftcollection = binary_to_base58(nftcollectionbytes);
